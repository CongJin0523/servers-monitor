...
public class TerminalWebSocket {
  ...
  private static SshMapper sshMapper;

  @Resource
  public void setSshMapper(SshMapper sshMapper) {
  ...
  private boolean createSshConnection(Session session, ClientSsh ssh, String ip) throws IOException{
    try {
      log.warn("{} {} {}",ssh.getUsername(), ip, ssh.getPort());
      JSch jSch = new JSch();
      ...
      js.setConfig("PreferredAuthentications", "publickey,keyboard-interactive,password");
